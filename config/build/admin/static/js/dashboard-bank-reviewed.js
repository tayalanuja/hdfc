...
$(document).ready(function() {
  ...
  const success = {
    'url': 'https://credit.in-d.ai/hdfc_life/credit/review_admin_dashboard',
    'headers': {
        ...
        'columns': [
          ...
          {'data': 'job_id',
            ...
            'render': function(data, type, row) {
              ...
              return `<a href='${row.review_status == 'No'? 'localization.html?job_id='+data+'':'calculations.html?job_id='+data+''}'>Procceed</a>`
            },
          },
